...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  ...
	  //招聘启事部分的点击功能，事件委派
	  (0, _jquery2.default)('#jionUs').delegate('.jion-us-title', 'click', function (event) {
	    var _btn = (0, _jquery2.default)(this).children().last(),
	        _isActive = _btn.attr('class'),
	        _brother = (0, _jquery2.default)(this).next();
